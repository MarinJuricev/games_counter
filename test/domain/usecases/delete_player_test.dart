...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final actualResult =
          await deletePlayer(DeletePlayerParams(playerToDelete: testPlayer1));
  ...
  test(
    ...
    () async {
      when(mockGameRepository.getGame()).thenAnswer((_) async => Right(null));

      final actualResult =
          await deletePlayer(DeletePlayerParams(playerToDelete: testPlayer2));
